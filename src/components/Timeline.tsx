...
// const timelineSortedByDate = (timeline as any).sort((a: any, b: any) => {
...
//   "Software Development": "bg-gray-200 text-gray-800",
...
//       <span className="absolute -left-3 flex h-6 w-6 items-center justify-center rounded-full bg-gray-300 ring-8 ring-white ">
//         <svg
